...
-- Old: 0x74f3df83a9a511a0
-- New: 0x1bd0081d0cc23e56
-- Date: 2025-11-24
...
DO $$
DECLARE
  v_old_wallet TEXT := '0x74f3df83a9a511a0';
  v_new_wallet TEXT := '0x1bd0081d0cc23e56';
...
DELETE FROM user_gum_balances WHERE wallet_address = '0x1bd0081d0cc23e56';
DELETE FROM gum_transactions WHERE wallet_address = '0x1bd0081d0cc23e56';
DELETE FROM user_gum_cooldowns WHERE wallet_address = '0x1bd0081d0cc23e56';
DELETE FROM user_profiles WHERE wallet_address = '0x1bd0081d0cc23e56';

-- 2. Update the main profile (this updates locker_assignments view automatically)
UPDATE user_profiles 
SET wallet_address = '0x1bd0081d0cc23e56'
WHERE wallet_address = '0x74f3df83a9a511a0';
...
DO $$
BEGIN
  DELETE FROM paradise_motel_room7_visits WHERE wallet_address = '0x1bd0081d0cc23e56';
  DELETE FROM crack_the_code WHERE wallet_address = '0x1bd0081d0cc23e56';
  DELETE FROM flunko_clicks WHERE wallet_address = '0x1bd0081d0cc23e56';
  DELETE FROM homecoming_dance_attendance WHERE wallet_address = '0x1bd0081d0cc23e56';
  DELETE FROM paradise_motel_entries WHERE wallet_address = '0x1bd0081d0cc23e56';
  DELETE FROM paradise_motel_room7_keys WHERE wallet_address = '0x1bd0081d0cc23e56';
  DELETE FROM cafeteria_button_clicks WHERE wallet_address = '0x1bd0081d0cc23e56';
  DELETE FROM friday_night_lights_clicks WHERE wallet_address = '0x1bd0081d0cc23e56';
  DELETE FROM picture_day_votes WHERE user_wallet = '0x1bd0081d0cc23e56';
  
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'flow_drawing_entries') THEN
    DELETE FROM flow_drawing_entries WHERE wallet_address = '0x1bd0081d0cc23e56';
  END IF;
  
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'digital_lock_attempts') THEN
    DELETE FROM digital_lock_attempts WHERE wallet_address = '0x1bd0081d0cc23e56';
  END IF;
  
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'terminal_activities') THEN
    DELETE FROM terminal_activities WHERE wallet_address = '0x1bd0081d0cc23e56';
  END IF;
  
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'magic_carpet_logs') THEN
    DELETE FROM magic_carpet_logs WHERE wallet_address = '0x1bd0081d0cc23e56';
  END IF;
  
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'flow_logs') THEN
    DELETE FROM flow_logs WHERE wallet_address = '0x1bd0081d0cc23e56';
  END IF;
  
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'semester_zero_allowlist') THEN
    DELETE FROM semester_zero_allowlist WHERE wallet_address = '0x1bd0081d0cc23e56';
  END IF;
  
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'weekly_objectives_completed') THEN
    DELETE FROM weekly_objectives_completed WHERE wallet_address = '0x1bd0081d0cc23e56';
  END IF;
  
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'chat_messages') THEN
    DELETE FROM chat_messages WHERE wallet_address = '0x1bd0081d0cc23e56';
  END IF;
  
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'feedback_reports') THEN
    DELETE FROM feedback_reports WHERE wallet_address = '0x1bd0081d0cc23e56';
  END IF;
END $$;
...
SET user_wallet = '0x1bd0081d0cc23e56'
WHERE user_wallet = '0x74f3df83a9a511a0';
...
SELECT 
  ...
  updated_at
FROM user_profiles
WHERE wallet_address = '0x1bd0081d0cc23e56';
