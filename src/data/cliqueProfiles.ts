...
export const BACKGROUND_PATTERNS = {
  ...
  tiltedGrid: "data:image/svg+xml,%3Csvg width='25' height='25' xmlns='http://www.w3.org/2000/svg'%3E%3Cdefs%3E%3Cpattern id='tiltedGrid' x='0' y='0' width='25' height='25' patternUnits='userSpaceOnUse' patternTransform='rotate(45)'%3E%3Cpath d='M0,0 L0,25 M12.5,0 L12.5,25 M25,0 L25,25' stroke='%23000000' stroke-opacity='0.15' stroke-width='1' fill='none'/%3E%3Cpath d='M0,0 L25,0 M0,12.5 L25,12.5 M0,25 L25,25' stroke='%23000000' stroke-opacity='0.15' stroke-width='1' fill='none'/%3E%3C/pattern%3E%3C/defs%3E%3Crect width='100%25' height='100%25' fill='url(%23tiltedGrid)'/%3E%3C/svg%3E"
};
...
export const CLIQUE_PROFILES: Record<string, CliqueProfile> = {
  ...
  "flunko": {
    ...
    lastLogin: "Currently online (always)",
    profileViews: 2847,
    aboutMe: "What's up everyone! I'm just a chill dude who loves the finer things in life - video games, good movies, and appreciating beautiful women. I spend most of my time at the arcade perfecting my Street Fighter combos or jamming on my guitar. When I'm not gaming, you can find me just chillin' in my secret clubhouse in the woods with my buddies - it's our own little paradise away from all the drama! Life's too short to stress about the small stuff, so I just go with the flow and enjoy the ride. Looking for fellow cool cats who appreciate the art of relaxation and good times! 🎮🎸🏠",
    ...
    topFriends: [
      ...
      { name: "Snugglebug", status: "Sweetest friend 🦋" }
    ],
