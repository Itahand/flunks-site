// ✅ Flunky Uppy Score Submission API
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  console.log('🦘 Submitting Flunky Uppy score:', { wallet: wallet.slice(0, 8) + '...', score, username });
  ...
  console.log('✅ Flunky Uppy score submitted successfully:', data);
